...
- Criar, excluir e editar novo chamado.
...
- Pesquisa e filtro dos chamados, ordenacão, persistência com localStorage e JSON, camada assíncrona, Loading e tratamento de erros e a organização mínima em módulos.
